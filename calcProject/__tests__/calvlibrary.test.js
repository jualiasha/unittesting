...
describe("Test sum with integers one bby one", () => {
...
describe("Testing parameter is missing throw an exception", () => {
...
describe("Testing Integers subtraction", () => {
  const testValues = [
    [1, 1, 0],
    [2, 3, -1],
    [-2, -4, 2],
